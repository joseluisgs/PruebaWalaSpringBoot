...
public class AdminController {
    ...
    public String gestionUsuarios(Model model,
        ...
        org.springframework.data.domain.Page<User> usuariosPage;
    ...
    public String gestionProductos(Model model,
        ...
        org.springframework.data.domain.Page<Product> productosPage;
    ...
    public String gestionVentas(Model model,
        ...
        org.springframework.data.domain.Page<Purchase> comprasPage;
